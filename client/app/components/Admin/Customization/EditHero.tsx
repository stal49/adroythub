...
const EditHero: FC<Props> = (props: Props) => {
  ...
  return (
    <>
      <div className="w-full 1000px:flex items-center text-black dark:text-white">
        ...
        <div className="1000px:w-[60%] flex flex-col items-center 1000px:mt-[0px] text-center 1000px:text-left mt-[150px]">
          <textarea
            className="dark:text-white resize-none text-[#000000c7] text-[20px] px-3 w-full 1000px:text-[30px] 1500px:text-[50px] font-[500] font-Josefin py-2 1000px:leading-[75px] 1500px:w-[60%] 1100px:w-[78%] outline-none bg-transparent block"
