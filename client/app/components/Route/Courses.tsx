  ...
  return (
    <div>
      <div className={`w-[90%] 800px:w-[80%] m-auto`}>
        ...
        <br />
        <button className="text-xs sm:text-sm md:text-base bg-purple-500 p-2 sm:p-3 md:p-4 rounded-xl sm:rounded-2xl text-white dark:text-white mt-4"> Register Now!</button>
        <br />
        <br />
