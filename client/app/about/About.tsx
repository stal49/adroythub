...
const testimonials = [
  ...
  },
  {
    ...
    review: 'Our workshop at Shri Chhatrapati Shivaji Maharaj College Of Engineering, Ahmednagar, was a remarkable experience for everyone involved. The students showed immense interest in the topics covered, and the interactive sessions were particularly well-received. Our team of experts delivered comprehensive content on cutting-edge technologies, ensuring that participants gained practical knowledge applicable to their future careers. The college’s supportive environment made the workshop smooth and successful. We are grateful for the opportunity to collaborate with such a prestigious institution and are excited about the positive impact this workshop has had on the students’ educational journey.',
},
  {
    id: '6',
    name: 'Shri Chhatrapati Shivaji Maharaj College Of Engineering, Ahmednagar',
...
},
{
  ...
  review: 'The workshop at SPIT Polytechnic College, Kurund, Shirur, was an inspiring event that left a lasting impact on both students and faculty. Our team introduced a variety of practical sessions that aligned perfectly with the students’ academic curriculum and future career aspirations. The enthusiasm and eagerness to learn demonstrated by the participants made the workshop particularly rewarding. The college’s commitment to providing quality education was evident in their support and organization, which contributed significantly to the workshop’s success. We are proud to have been part of this enriching experience and look forward to more such collaborations in the future.',
},
{
  id: '8',
  name: 'SPIT Polytechnic college Kurund, Shirur',
...
const About = () => {
  ...
  <div className="w-[95%] 800px:w-[85%] m-auto flex flex-col 800px:flex-row justify-between items-center 800px:items-start">
    ...
    <Image
      ...
      alt="about us!"
      className="h-60 w-60 800px:h-96 800px:w-96 mt-10 800px:mt-20 rounded-3xl border-4 border-gray-400 p-4"
    />
  </div>
      
      <div className="w-[95%] 800px:w-[85%] m-auto flex flex-row justify-between align-middle ">
      <p className="text-[20px] font-Poppins m-20 pt-10">
        ...
        <ul className="space-y-4">
          <li className="flex items-start">
            <span className="text-gradient font-bold mr-2">Expert-Led Courses:</span>
            <span>Learn from seasoned professionals with real-world experience.</span>
          </li>
          <li className="flex items-start">
            <span className="text-gradient font-bold mr-2">Flexible Learning:</span>
            <span>Access course materials anytime, anywhere, and study at your own pace.</span>
          </li>
          <li className="flex items-start">
            <span className="text-gradient font-bold mr-2">Comprehensive Curriculum:</span>
            <span>Stay ahead with courses designed to keep you competitive in the job market.</span>
          </li>
          <li className="flex items-start">
            <span className="text-gradient font-bold mr-2">Career Support:</span>
            <span>Benefit from our resources and guidance to enhance your career prospects.</span>
          </li>
          <li className="flex items-start">
            <span className="text-gradient font-bold mr-2">Certification:</span>
            <span>Earn certificates recommended by high-profile industry leaders and personalities, enhancing your professional credibility.</span>
          </li>
        </ul>
      </div>
        </p>
      </div>
      <div className="w-[95%] 800px:w-[85%] m-auto  800px:flex-row justify-between items-center 800px:items-start">
      <div className="flex justify-center mb-10 800px:mb-0">
          {theme === "dark" ? (
            <Image
        ...
        <div>
            <p className="text-gradient2 text-[16px] 800px:text-[20px] font-Poppins m-5 800px:m-20 pt-5 800px:pt-10">
             At Adroythub, We believe in the power of collaboration to deliver high-quality education to our learners. We proudly partner with a diverse group of experienced course-selling teachers who bring their unique expertise and insights to our platform. By working together, we ensure that our students have access to wide array of courses that are both relevant and impactful. Our partnerships allow us to continually expand our offerings, providing learners with the tools and knowledge they need to succeed in todays competitive environment. 
          <br />
          <br />
          <br />
          </p>
