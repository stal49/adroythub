        ...
        <div className="text-black dark:text-white">
            ...
            <div className="w-[95%] 800px:w-[85%] m-auto flex flex-col 800px:flex-row justify-between items-center 800px:items-start">
                ...
                <Image
                        ...
                        className="h-[481px] w-[626px] mt-10 800px:mt-20 rounded-3xl  p-4"
                    /> 
                    <p className="text-[20px] font-Poppins m-20">
                ...
                <div className="w-[95%] 800px:w-[85%] m-auto flex flex-row justify-between align-middle ">
                    <p className="text-[20px] font-Poppins m-20">
                        ...
                        <ul className="m-3">
                            ...
                            <li className="text-gradient">Programming Languages :</li>
                            <ul className="m-3">
                            ...
                            <li className="text-gradient">Marketing Roles :</li>
                            <ul className="m-3">
                            ...
                            <li className="text-gradient">Business Communication :</li>
                            <ul className="m-3">
                ...
                <div className="w-[95%] 800px:w-[85%] m-auto flex flex-row justify-between align-middle ">
                    <p className="text-[20px] font-Poppins m-20">
                        ...
                        <br />
                            ...
                            <br />Internships typically last 3 to 6 months, giving you ample time to immerse yourself in projects and gain substantial experience.
                            <br />
                            <br />
                ...
                <div className="w-[95%] 800px:w-[85%] m-auto flex flex-row justify-between align-middle ">
                    <p className="text-[20px] font-Poppins m-20">
                        ...
                        <br />
                        <span className="text-gradient2 text-[24px]">Application Process</span>
                        <br />
                        <br />
                        <ul>
                    ...
                    <Image
                        ...
                        alt="about us!"
                        className="h-[481px] w-[466px] mt-10 800px:mt-20 rounded-3xl  p-4"
                    />
                </div>
                    ...
                    <p className="text-[20px] font-Poppins m-20">
                        ...
                        <br />
                        <span className="text-gradient2 text-2xl justify-center align-middle">Alumni Testimonials</span> 
                        </h1>
                        
                         
                        </p>
                        <div className="mt-10 max-w-6xl mx-auto grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 px-4">
                   ...
                   <div className="w-[90%] 800px:w-[80%] m-auto">
                     ...
                     <br />
                     <br />
                     <div className="text-[22px] font-Poppins m-20">Ready to take the next step in your career? <span className="text-gradient2"> Apply Now</span> to join the Adroythub Internship Program. <br />Gain real-world experience, build your portfolio, and start your professional journey with us.</div>
                     <br />
                     <br />
                </div>
        </div>
